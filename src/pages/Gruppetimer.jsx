      ...
      <div className="section">
        ...
        <div className="gruppetimer-section">
          <div className="gruppetimer-info">
            ...
            <div className="gruppetimer-info-text">
              Vi vil få inn din bestilling, så vil vi sette deg opp på neste
              ledige time, du kan også ringe ned å bestille om du vil. Vi
              kontakter deg på ditt telefonnummer. Vår kontaktinformasjon og
              åpningssider finner du enkelt tilgjengelig på kontakt oss, om oss,
              og nederst på nettsiden.
            </div>
          </div>
